...
Локальный сервис для мониторинга климата в комнате и автоматизации устройств климат контроля комнаты.
...
## Пример работы Увлажнитель
- Ручное включение
- Изменение режима работы
- Изменение порогов, когда влажность слишком низкая, увлажнитель включится автоматически

https://github.com/user-attachments/assets/b42487a8-9d90-421f-8b4d-e57845facd2b

## Пример работы Очиститель
- Ручное включение
- Изменение скорости работы
- Изменение порогов, когда слишком много пыли в воздухе, очиститель включится автоматически

https://github.com/user-attachments/assets/4f2ecc26-1864-43e6-b831-457a20b6e3a4
